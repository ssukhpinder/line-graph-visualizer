import { ExtractedData, DataExtractionResult } from "../../DataExtractionResult";
...
export interface DataExtractor<T extends ExtractedData> {
     ...
     */
    id: string;
    getExtractions(data: unknown, extractionCollector: ExtractionCollector<T>, context: DataExtractorContext): void;
}
